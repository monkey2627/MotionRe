...
public struct LogData : IFlatbufferObject
{
  ...
  public static Offset<solarxr_protocol.datatypes.LogData> Pack(FlatBufferBuilder builder, LogDataT _o) {
    if (_o == null) return default(Offset<solarxr_protocol.datatypes.LogData>);
