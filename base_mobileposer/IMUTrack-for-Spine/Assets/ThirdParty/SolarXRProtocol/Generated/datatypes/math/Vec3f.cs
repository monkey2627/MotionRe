...
public struct Vec3f : IFlatbufferObject
{
  ...
  public static Offset<solarxr_protocol.datatypes.math.Vec3f> Pack(FlatBufferBuilder builder, Vec3fT _o) {
    if (_o == null) return default(Offset<solarxr_protocol.datatypes.math.Vec3f>);
    return CreateVec3f(
      builder,
      _o.X,
      _o.Y,
